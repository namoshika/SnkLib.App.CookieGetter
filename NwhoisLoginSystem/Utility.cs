...
namespace NwhoisLoginSystem
{
    static class Utility
    {
        ...
        public static string GetResponseText(string url, CookieContainer cookies, int defaultTimeout)
        {
            ...
            try
            {
                ...
                try { webRes = (HttpWebResponse)webReq.GetResponse(); }
                catch (WebException ex) { webRes = ex.Response as HttpWebResponse; }
                if (webRes == null)
                    return null;
