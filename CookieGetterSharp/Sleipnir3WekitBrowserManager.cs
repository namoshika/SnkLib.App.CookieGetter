...
namespace Hal.CookieGetterSharp {
	class Sleipnir3WekitBrowserManager : IBrowserManager {
		const string COOKIEPATH = "%APPDATA%\\Fenrir Inc\\Sleipnir\\setting\\modules\\ChromiumViewer\\Default\\Cookies";

		// プロファイル対応 6/29
		private readonly string DATAFOLDER = "%APPDATA%\\Fenrir Inc\\Sleipnir\\setting\\modules\\ChromiumViewer\\";
		...
		public BrowserType BrowserType {
			get { return BrowserType.Sleipnir3Webkit; }
		}
