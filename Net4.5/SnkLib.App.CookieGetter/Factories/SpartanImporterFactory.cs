...
#pragma warning disable 1591
        ...
        public override IEnumerable<ICookieImporter> GetCookieImporters()
        {
            if (_importer == null)
            {
                ...
                cookieFolder = System.IO.Directory.GetDirectories(cookieFolder, "Microsoft.Windows.Spartan_*")
                    .DefaultIfEmpty(cookieFolder + @"\Microsoft.Windows.Spartan_xxx").FirstOrDefault();
